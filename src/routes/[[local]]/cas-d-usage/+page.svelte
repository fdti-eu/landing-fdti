							...
							<div class="flex flex-wrap gap-2 justify-center">
								{#each allIndustries as industry}
									<button
										...
										class="px-4 py-2 rounded-lg text-sm font-semibold transition-all {selectedIndustry ===
										industry
											? 'bg-yellow text-darkGrey'
											: 'bg-white/10 text-white hover:bg-white/20 border border-white/20'}"
									>
							...
							<div class="flex flex-wrap gap-2 justify-center">
								{#each allTags as tag}
									<button
										...
										class="px-3 py-1.5 rounded-md text-xs font-medium transition-all {selectedTag ===
										tag
											? 'bg-yellow text-darkGrey'
